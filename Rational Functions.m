...
function SigmaJ(J,g,L,K) 

/* Input : A function J(t) which is an element in field L(t) and g which is in Gal(L/K) 
...
G,iota,sigma:=AutomorphismGroup(L,K); 
